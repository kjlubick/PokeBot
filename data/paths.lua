local paths = {
	...
	{40, {5,3}, {s="setArea",a="Pallet Rival"}, {5,4}, {7,4}, {s="squirtleIChooseYou"}, {5,4}, {5,6}, {s="fightBulbasaur"}, {s="split"}, {5,12}},

-- 1: RIVAL 1

	-- Let's try this escape again
	{0, {12,12}, {s="setArea",a="Pallet Town"}, {c="viridianExp"}, {c="encounters",limit=4}, {9,12}, {9,2}, {10,2}, {10,-1}},
	-- First encounters
	...
	-- Nidoran
	{33, {39, 9}, {s="setArea",a="Nidoran grass"}, {c="nidoranBackupExp"}, {c="encounters",limit=7,extra="spearow"}, {35, 9}, {35,12}, {33,12}, {c="catchNidoran"}, {s="catchNidoran"}, {33,12}, {s="split"}, {37,12}, {37,9}, {40,9}},
...
-- 2: NIDORAN
	...
	-- Forest entrance
	{50, {4,7}, {s="setArea",a="Viridian Forest"}, {4,1}, {5,1}, {5,0}},
	-- Viridian Forest
	...
	{47, {4,7}, {4,1}, {5,1}, {5,0}},
	-- Road to Pewter City
	{13, {3,11}, {s="setArea",a="Pewter City"}, {3,8}, {8,8}, {8,-1}},
	-- Pewter City
	{2, {18,35}, {18,22}, {19,22}, {19,13}, {10,13}, {10,18}, {16,18}, {16,17}},
	-- Brock
	{54, {4,13}, {s="setArea",a="Brock's Gym"}, {4,8}, {1,8}, {1,4}, {4,4}, {4,2}, {s="interact",dir="Up"}, {s="fightBrock"}, {s="split"}, {s="emuSpeed",percent=100}, {4,14}},
...
-- 5: MT. MOON
	...
	-- Enter Cerulean
	{3, {0,18}, {s="setArea",a="Cerulean"}, {14,18}, {s="dodgeCerulean"}, {19,18}, {19,17}},
	-- Cerulean Center
	...
	{230, {2,1}, {2,8}},
	-- Rival 2
	{3, {9,12}, {s="setArea",a="Cerulean Rival"}, {21,12}, {21,6}, {s="rivalSandAttack"}, {21,-1}},
	-- Nugget bridge
	{35, {11,35}, {s="setArea",a="Nugget Bridge"}, {11,32}, {s="interact",dir="Up"}, {10,32}, {10,29}, {s="interact",dir="Up"}, {11,29}, {11,26}, {s="interact",dir="Up"}, {10,26}, {10,24}, {s="teachThrash"}, {10,23}, {s="interact",dir="Up"}, {11,23}, {11,21}, {s="teachThrash"}, {11,20}, {s="interact",dir="Up"}, {s="redbarMankey"}, {10,20}, {10,19}, {s="teachThrash"}, {10,15}, {s="waitToFight"}, {s="teachThrash"}, {s="split"}, {10,8}, {20,8}},
...
-- 6: NUGGET BRIDGE
	...
	-- Misty
	{65, {4,13}, {s="setArea",a="Misty's Gym"}, {c="potion",b=false}, {4,8}, {2,8}, {2,5}, {7,5}, {7,3}, {6,3}, {5,3}, {s="waitToFight"}, {s="potionBeforeMisty"}, {5,2}, {s="waitToFight",dir="Left"}, {s="split"}, {s="tweetMisty"}, {5,3}, {7,3}, {7,5}, {5,5}, {5,14}},
...
-- 7: MISTY
	...
	{17, {17,14}, {s="setArea",a="Vermilion City"}, {c="catchOddish"}, {17,15}, {s="potion",hp=9,yolo=5}, {17,19}, {s="catchOddish"}, {11,29}, {s="potion",hp=9,yolo=5}, {11,29}, {s="waitToFight",dir="Down"}, {10,29}, {10,30}, {s="potion",hp=9,yolo=5}, {10,31}, {9,31}, {9,32}, {s="potion",hp=20,yolo=18,chain=true}, {s="teach",move="bubblebeam",replace="water_gun"}, {9,36}},
	-- Enter Vermilion
	...
	-- Mew
	{94, {14,0}, {s="setArea",a="S.S. Anne"}, {14,3}},
	-- First deck
	...
	-- Trashcans
	{92, {4,17}, {s="setArea",a="Surge's Gym"}, {4,16}, {2,16}, {2,11}, {s="trashcans"}, {4,6}, {4,3}, {5,3}, {5,2}, {s="interact",dir="Up"}, {s="fightSurge"}, {s="split"}, {4,2}, {4,13}, {5,13}, {5,18}},

-- 8: SURGE

	-- To bicycle house
	{5, {12,20}, {s="setArea",a="Bicycle Shop"}, {15,20}, {15,19}, {s="skill",move="cut",done=0x0D4D}, {15,14}, {9,14}, {9,13}},
	-- Bicycle cert
	...
	-- TPP's Bane
	{20, {0,8}, {s="setArea",a="Route 9"}, {4,8}, {s="skill",move="cut",done=0x0C17,val=2}, {13,8}, {13,9}, {s="interact",dir="Down"}, {12,9}, {12,12}, {23,12}, {23,11}, {29,11}, {29,12}, {41,12}, {41,10}, {40,10}, {40,9}, {s="interact",dir="Up"}, {41,9}, {41,6}, {39,6}, {39,4}, {45,4}, {45,3}, {51,3}, {51,8}, {60,8}},
	-- To the cave
	{21, {0,8}, {3,8}, {3,10}, {13,10}, {13,15}, {14,15}, {14,26}, {3,26}, {3,18}, {8,18}, {8,17}},
	-- Rock tunnel
	{82, {15,3}, {s="setArea",a="Rock Tunnel"}, {c="potion",b=false}, {s="item",item="repel"}, {15,6}, {23,6}, {23,7}, {s="interact",dir="Down"}, {s="redbarCubone"}, {22,7}, {22,10}, {37,10}, {37,3}},
	-- B1
	...
	-- To Lavender Town
	{21, {8,54}, {s="setArea",a="Lavender Town"}, {15,54}, {15,65}, {11,65}, {11,69}, {6,69}, {6,72}},
	-- Through Lavender
	...
	-- Celadon
	{6, {49,11}, {s="setArea",a="Celadon Mart"}, {14,11}, {14,14}, {10,14}, {10,13}},
	-- Department store
	...
	{186, {7,2}, {-1,2}},
	-- To the Fly house
	{27, {17,4}, {s="setArea",a="HM02 Fly"}, {10,4}, {10,6}, {7,6}, {7,5}},
	-- Fly house
...
-- 9: FLY
	...
	-- To the tower
	{4, {3,6}, {s="setArea",a="Pokemon Tower"}, {14,6}, {14,5}},
	-- Pokemon Tower
...
-- 10: POKéFLUTE
	...
	-- Leave Celadon
	{6, {41,10}, {s="setArea",a="Snorlax"}, {s="item",item="super_repel",chain=true}, {s="bicycle"}, {41,11}, {14,11}, {14,14}, {2,14}, {2,18}, {-1,18}},
	-- トトロだ！
	{27, {39,10}, {27,10}, {s="playPokeflute"}, {23,10}},
	-- Snorlax pass
	{186, {7,8}, {-1,8}},
	-- Bicycle road
	{27, {17,10}, {s="setArea",a="Bicycle Road"}, {12,10}, {12,13}, {11,13}, {11,18}},
	-- Forced down inputs
	...
	-- Safari City
	{7, {0,16}, {s="setArea",a="Safari Zone"}, {3,16}, {3,20}, {23,20}, {23,14}, {29,14}, {29,15}, {35,15}, {35,8}, {37,8}, {37,2}, {22,2}, {22,4}, {18,4}, {18,3}},
	-- Safari entrance
	...
	-- To Saffron
	{18, {0,3}, {s="setArea",a="Saffron City"}, {4,3}, {4,9}, {10,9}, {10,10}, {12,10}},
	-- Thirsty guard
	{76, {0,4}, {6,4}},
	-- Saffron entry
	...
	-- Silph Co
	{181, {10,17}, {s="setArea",a="Silph Co."}, {10,9}, {8,9}, {8,1}, {20,1}, {20,0}},
	-- Elivator
	...
	-- Rival 5
	{212, {5,3}, {s="setArea",a="Silph Rival"}, {4,3}, {4,2}, {3,2}, {c="potion",b=false}, {s="silphRival"}, {3,7}, {c="potion",b=true,yolo=true}, {5,7}},
	-- Giovanni
	{235, {3,2}, {s="setArea",a="Silph Giovanni"}, {3,11}, {2,11}, {2,16}, {s="interact",dir="Right"}, {2,15}, {5,15}, {s="potion",hp=16,yolo=12}, {6,15}, {6,14}, {s="interact",dir="Up"}, {6,13}, {s="fightXAccuracy"}, {s="fightSilphGiovanni"}, {s="split"}, {s="waitToPause"}, {s="skill",move="dig",map=235}},
...
-- 11: SILPH CO.
	...
	-- To Koga
	{7, {19,28}, {s="setArea",a="Koga's Gym"}, {5,28}, {5,27}},
	-- Koga
...
-- 12: KOGA
	...
	{8, {3,0}, {s="setArea",a="Cinnabar Mansion"}, {3,4}, {6,4}, {6,3}},
	-- F1
	{165, {5,27}, {5,10}},
	-- F2
	...
	-- Erika
	{134, {4,17}, {s="setArea",a="Erika's Gym"}, {4,16}, {1,16}, {1,9}, {0,9}, {0,4}, {1,4}, {s="skill",move="cut",done=0x0D4D}, {4,4}, {s="interact",dir="Up"}, {s="fightErika"}, {s="split"}, {4,5}, {5,5}, {5,6}, {s="skill",move="cut",dir="Down",done=0x0D4D}, {5,18}},
...
-- 14: BLAINE
	...
	-- Saffron gate
	{76, {0,4}, {s="setArea",a="Saffron City"}, {6,4}},
	-- Saffron edge
	{18, {18,10}, {s="earthquakeElixer",min=4,chain=true}, {s="bicycle"}, {20,10}},
	-- Saffron again
	{10, {0,18}, {3,18}, {3,6}, {31,6}, {31,4}, {34,4}, {34,3}},
	-- Sabrina
	{178, {8,17}, {s="setArea",a="Sabrina's Gym"}, {8,16}, {11,16}, {11,15}, {16,17}, {16,15}, {15,15}, {18,3}, {18,5}, {15,5}, {1,5}, {11,11}, {11,8}, {10,8}, {s="waitToFight",dir="Left"}, {s="split"}, {11,8}, {11,11}, {s="earthquakeElixer",min=4,chain=true}, {s="skill",move="dig",map=178}},
...
-- 15: SABRINA
	...
	-- Giovanni Gym
	{45, {16,17}, {c="potion",b=false}, {s="setArea",a="Giovanni's Gym"}, {16,16}, {14,16}, {14,9}, {13,9}, {13,7}, {15,7}, {15,4}, {12,4}, {12,5}, {10,5}, {s="setArea",a="Machoke"}, {10,4}, {s="fightGiovanniMachoke"}, {10,5}, {s="setArea",a="Giovanni's Gym"}, {13,5}, {13,4}, {15,4}, {15,7}, {13,7}, {13,11}, {14,11}, {14,16}, {16,16}, {16,18}},
	-- Reset Gym
	{1, {32,8}, {32,7}},
	-- Giovanni
...
-- 16: GIOVANNI
	...
	-- To Pokemon League
	{33, {39,9}, {s="setArea",a="Viridian Rival"}, {35,9}, {35,12}, {31,12}, {31,5}, {29,5}, {s="viridianRival"}, {16,5}, {16,12}, {5,12}, {5,10}, {11,10}, {11,6}, {8,6}, {8,5}},
	-- Pokemon League 1
	{193, {4,7}, {4,0}},
	-- PL 2
	...
	-- Elite Four entrance
	{9, {10,17}, {s="setArea",a="Elite Four"}, {10,5}},
	-- Last Center
	{174, {7,11}, {15,9}, {15,8}, {s="depositPokemon"}, {7,8}, {7,7}, {s="centerSkip"}, {4,7}, {3,7}, {3,2}, {8,2}, {8,0}},

-- 17: LORELEI

	{245, {4,5}, {s="setArea",a="Lorelei"}, {c="potion",b=false}, {4,2}, {s="interact",dir="Right"}, {s="lorelei"}, {s="split"}, {4,0}},

	{246, {4,5}, {s="setArea",a="Bruno"}, {s="item",item="elixer",poke="nidoking"}, {4,2}, {s="interact",dir="Right"}, {s="bruno"}, {s="split"}, {4,0}},

	{247, {4,5}, {s="setArea",a="Agatha"}, {s="potion",hp=113,full=true}, {4,2}, {s="interact",dir="Right"}, {s="agatha"}, {s="split"}, {4,1}, {s="prepareForLance"}, {s="ether"}, {4,0}},

	{113, {6,11}, {s="setArea",a="Lance"}, {6,2}, {s="lance"}, {s="waitToFight"}, {s="split"}, {5,2}, {5,1}, {s="prepareForBlue"}, {5,-1}},

	{120, {4,3}, {s="setArea",a="Blue"}, {s="blue"}, {3,0}},
